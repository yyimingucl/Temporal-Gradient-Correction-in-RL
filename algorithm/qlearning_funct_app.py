...
def q_learning_value_function_approx(
    ...
    for _ in range(num_episodes):
        ...
        while not env.is_terminal() and steps < max_steps:
            ...
            # update the weights
            qweights = q_learning_update(actions, qweights, s_rep, a, r, next_s_rep, gamma, alpha)
...
def q_learning_update(actions, qweights, s_rep, a, r, next_s_rep, gamma, alpha):
    """
