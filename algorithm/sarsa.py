# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 03:36:43 2020
...
def sarsa_value_function_approx(
    ...
    for _ in range(num_episodes):
        ...
        while not env.is_terminal() and steps < max_steps:
            ...
            """
            # update the weights
            qweights,lms = sarsa_update(qweights, s_rep, a, r, next_s_rep, next_a, 
...
def sarsa_update(qweights, s_rep, a, r, next_s_rep, next_a, 
                 gamma, alpha, lms, beta):
    ...
    qweights[a] += alpha*(s_rep-gamma*s_rep)*s_rep.T*lms
    return qweights, lms
